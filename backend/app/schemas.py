...
class BatchOut(BatchUpdate): model_config=ConfigDict(from_attributes=True); id:int
class JobIn(BaseModel):
 ...
 planned_date:date; operator:str=Field(min_length=1,max_length=80); description:str=""
